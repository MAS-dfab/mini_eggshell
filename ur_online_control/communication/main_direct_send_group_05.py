...
# python path to your file....\mini_eggshell\ur_online_control\communication\main_direct_send_group_05.py
...
server_port = 30003
ur_ip = "192.168.10.10"
tool_angle_axis = [31, -68.294, 122.0, 3.1416, 0.0, 0.0]
# ===============================================================

# COMMANDS
# ===============================================================
path = os.path.dirname(os.path.join(__file__))
filename = os.path.join(path, "..", "commands_group_05.json")
